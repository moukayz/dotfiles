...
@ranger.api.register_linemode
class TotalSizeLineMode(DevIconsLinemode):
    name = "total_size"

    def infostring(self, fobj: FileSystemObject, metadata):
        if fobj.is_directory:
            return human_readable(get_size(fobj.path))
        else:
            return super().infostring(fobj, metadata)
