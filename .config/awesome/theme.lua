...
theme.font          = "Inconsolata 15"
-- set hotkeys widget font
theme.hotkeys_font = "Inconsolata 14"
theme.hotkeys_description_font = "Inconsolata 14"
...
theme.wallpaper = gfs.get_configuration_dir() .. "wallpapers/samurai.jpg"
